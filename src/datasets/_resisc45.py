...
import abc # Module for defining abstract base classes
...
class RESISC45:
    def __init(
        ...
        self.train_dataset = RESISC45Dataset(self, split='train', transforms=preprocess)
        ...
        self.test_dataset = RESISC45Dataset(self, split='test', transforms=preprocess)
